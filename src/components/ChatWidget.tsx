  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-[4.5rem] right-4 lg:bottom-6 lg:right-6 z-[100] w-12 h-12 lg:w-16 lg:h-16 rounded-full bg-card shadow-lg border-2 border-primary/30 transition-all duration-300 hover:scale-110 hover:shadow-xl ${
      ...
      {/* Widget Panel */}
      <div
        className={`fixed bottom-[4.5rem] right-4 lg:bottom-6 lg:right-6 z-[100] w-[calc(100vw-2rem)] max-w-sm lg:w-80 bg-card rounded-2xl shadow-2xl border border-border overflow-hidden transition-all duration-300 ${
          isOpen
